...
import aria2p
from hf_torrent.utils import enumerate_hf_repo, download_fn

def main(
    repo, hf_models, download,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--download", type=str, default="$HOME/./cache/hf-torrent-downloads")
